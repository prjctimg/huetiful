 ...
 * @returns The first truthy value
 */
declare function checkArg(arg: unknown, def: unknown): unknown;
declare const interpolatorConfig: {
    easingFunc: (t: number) => number;
    chromaInterpolator: import("./types").Interpolator;
    hueFixup: (arr: number[]) => number[];
    hueInterpolator: import("./types").Interpolator;
    lightnessInterpolator: import("./types").Interpolator;
};
/**
 * @internal
 ...
 */
declare function expressionParser(color: ColorToken, modeChannel: string, expression: string): number;
/**
 * @internal
 * @function
...
// okhsl.s
 */
declare function matchChromaChannel(colorspace: HueColorSpaces | string): string;
/**
 * @internal
 * @function
...
// okhsl.l
 */
declare function matchLightnessChannel(colorspace: HueColorSpaces | string): string;
/**
 *
 ...
 *
 */
declare function channelDifference(color: ColorToken, modeChannel: string): (subtrahend: ColorToken) => number;
/**
 ...
 * // false
 */
declare function isInteger(num: number | string): boolean;
/**
 * @internal
 ...
 *
 */
declare function normalize(value: number, modeChannel: string): number;
/**
 * @internal
 ...
 */
declare function matchDigits(s: string): number;
/**
 * @internal
 ...
 */
declare function matchComparator(s: string): string;
/**
 * @internal
...
export { expressionParser, matchLightnessChannel, matchChromaChannel, min, max, customSort, colorObjArr, sortedArr, filteredArr, customFindKey, colorObj, customConcat, inRange, random, isInteger, floorCeil, adjustHue, channelDifference, lt, neq, gt, gte, lte, eq, normalize, checkArg, getModeChannel, interpolatorConfig, matchComparator, matchDigits };
