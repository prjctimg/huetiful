 ...
 */
export function distribute(factor?: import('./filterBy.js').Factor, options?: import('./types.js').DistributionOptions): (collection: import('./token.js').Collection, options?: import('./types.js').DistributionOptions) => import('./token.js').Collection;
