...
*/
import type { ColorToken, HueColorSpaces, HueShiftOptions, InterpolatorOptions, PairedSchemeOptions, UniformColorSpaces } from './types';
/**
 *
 ...
 */
declare function scheme(schemeType: 'analogous' | 'triadic' | 'tetradic' | 'complementary' | string): (color: ColorToken, easingFunc?: (t: number) => number) => ColorToken[];
/**
 *
 ...
 */
declare function discoverPalettes(colors: ColorToken[], schemeType?: 'analogous' | 'triadic' | 'tetradic' | 'complementary', colorspace?: UniformColorSpaces): ColorToken[] | object;
/**
 *
 ...
 */
declare function hueShift(color: ColorToken, colorspace?: UniformColorSpaces, options?: HueShiftOptions): ColorToken[];
/**
 *
 ...
 *
 */
declare function interpolateSpline(colors: ColorToken[], colorspace?: HueColorSpaces, samples?: number, kind?: 'natural' | 'monotone' | 'basis', closed?: boolean, options?: InterpolatorOptions): ColorToken[];
/**
 * @internal
 */
declare function interpolator(colors: ColorToken[], colorspace?: HueColorSpaces, options?: object): (t: number) => import("culori/src/common").FindColorByMode<"lch" | "jch" | "dlch" | "lch65" | "lchuv" | "oklch" | "hsl" | "hsv" | "hsi" | "hwb" | "okhsl" | "okhsv" | "rgb" | "a98" | "cubehelix" | "dlab" | "jab" | "lab" | "lab65" | "lrgb" | "luv" | "oklab" | "p3" | "prophoto" | "rec2020" | "xyz50" | "xyz65" | "yiq">;
/**
 ...
 */
declare function pairedScheme(color: ColorToken, options?: PairedSchemeOptions): ColorToken[] | ColorToken;
/**
 *
...
export { discoverPalettes, hueShift, pairedScheme, pastel, scheme, interpolateSpline, interpolator };
