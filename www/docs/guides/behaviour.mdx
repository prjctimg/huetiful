...
Always try to define the mode of your color objects (be it arrays or plain objects) to get predictable output.


:::
 

The default colorspace is `'rec2020'` (aliased as `'rgb'`). This is because it supports Wide Color Gamut.
