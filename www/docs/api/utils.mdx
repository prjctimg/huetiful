---
title: Utils
description: Functions for querying color tokens.
---
...
> **achromatic**\<`Color`\>(`color`): `boolean`
...
[utils.ts:251](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/utils.ts#L251)

***

### alpha()

> **alpha**\<`Color`, `Amount`\>(`color`, `amount`?): `Amount` *extends* `undefined` ? `number` : `Color`
...
[utils.ts:84](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/utils.ts#L84)

***

### complimentary()

> **complimentary**\<`Color`, `Options`\>(`baseColor`, `options`?): [`ColorToken`](types.mdx#colortoken)
...
[utils.ts:747](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/utils.ts#L747)
...
[utils.ts:635](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/utils.ts#L635)

***

### lightness()

> **lightness**\<`Color`, `Options`\>(`color`, `options`?): [`ColorToken`](types.mdx#colortoken)
...
• **Options** *extends* `LightnessOptions`
...
[utils.ts:290](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/utils.ts#L290)

***

### luminance()

> **luminance**\<`Color`, `Amount`\>(`color`, `amount`?): `Amount` *extends* `number` ? [`ColorToken`](types.mdx#colortoken) : `number`
...
`Amount` *extends* `number` ? [`ColorToken`](types.mdx#colortoken) : `number`
...
[utils.ts:567](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/utils.ts#L567)

***

### mc()

> **mc**\<`Color`, `Value`\>(`modeChannel`): (`color`, `value`?) => `Value` *extends* `string` \| `number` ? [`ColorToken`](types.mdx#colortoken) : `number`
...
`Value` *extends* `string` \| `number` ? [`ColorToken`](types.mdx#colortoken) : `number`
...
[utils.ts:163](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/utils.ts#L163)
...
• **Bias** *extends* [`ColorFamily`](types.mdx#colorfamily)
...
[utils.ts:718](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/utils.ts#L718)
...
[utils.ts:682](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/utils.ts#L682)

***

### token()

> **token**\<`Color`, `Options`\>(`color`, `options`?): [`ColorToken`](types.mdx#colortoken)
...
[utils.ts:343](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/utils.ts#L343)
