---
title: Generators
description: Functions for making color scales and palettes.
---
...
> **discover**(`colors`, `options`): [`Collection`](types.mdx#collection)
...
• **colors**: [`Collection`](types.mdx#collection) = `[]`
...
[`Collection`](types.mdx#collection)
...
[generators.ts:397](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/generators.ts#L397)

***

### earthtone()

> **earthtone**(`baseColor`, `options`): [`ColorToken`](types.mdx#colortoken) \| [`ColorToken`](types.mdx#colortoken)[]

Creates a color scale between an earth tone and any color token using spline interpolation.

#### Parameters

• **baseColor**: [`ColorToken`](types.mdx#colortoken)

The color to interpolate an earth tone with.

• **options**: [`EarthtoneOptions`](types.mdx#earthtoneoptions)

Optional overrides for customising interpolation and easing functions.

#### Returns

[`ColorToken`](types.mdx#colortoken) \| [`ColorToken`](types.mdx#colortoken)[]
...
[generators.ts:471](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/generators.ts#L471)

***

### hueshift()

> **hueshift**\<`Color`, `Options`\>(`baseColor`, `options`): [`Collection`](types.mdx#collection)
...
• **Color** *extends* [`ColorToken`](types.mdx#colortoken)

• **Options** *extends* [`HueshiftOptions`](types.mdx#hueshiftoptions)
...
[generators.ts:86](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/generators.ts#L86)

***

### interpolator()

> **interpolator**(`baseColors`, `options`): [`ColorToken`](types.mdx#colortoken)[] \| [`ColorToken`](types.mdx#colortoken)
...
• **baseColors**: [`Collection`](types.mdx#collection) = `[]`
...
• **options**: [`InterpolatorOptions`](types.mdx#interpolatoroptions) = `undefined`
...
[generators.ts:295](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/generators.ts#L295)

***

### pair()

> **pair**\<`Color`, `Options`\>(`baseColor`, `options`?): [`Collection`](types.mdx#collection)
...
• **Options** *extends* [`PairedSchemeOptions`](types.mdx#pairedschemeoptions)
...
[generators.ts:219](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/generators.ts#L219)

***

### pastel()

> **pastel**\<`Color`, `Options`\>(`baseColor`, `options`?): [`ColorToken`](types.mdx#colortoken)
...
• **Options** *extends* [`TokenOptions`](types.mdx#tokenoptions-1)
...
[`ColorToken`](types.mdx#colortoken)
...
[generators.ts:167](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/generators.ts#L167)

***

### scheme()

> **scheme**(`baseColor`, `options`): [`Collection`](types.mdx#collection)
...
• **options**: [`SchemeOptions`](types.mdx#schemeoptions) = `{}`
...
[generators.ts:542](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/generators.ts#L542)
