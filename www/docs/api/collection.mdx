---
title: Collection
description: Functions for manipulating color token iterables.
---
...
> **distribute**\<`Iterable`, `Options`\>(`collection`, `options`?): [`Collection`](types.mdx#collection)
...
• **Iterable** *extends* [`Collection`](types.mdx#collection)

• **Options** *extends* [`DistributionOptions`](types.mdx#distributionoptions)
...
[collection.ts:237](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/collection.ts#L237)

***

### filterBy()

> **filterBy**\<`Iterable`, `Options`\>(`collection`, `options`): [`Collection`](types.mdx#collection)
...
• **Options** *extends* [`FilterByOptions`](types.mdx#filterbyoptions)
...
[collection.ts:336](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/collection.ts#L336)

***

### sortBy()

> **sortBy**\<`Iterable`, `Options`\>(`collection`, `options`?): [`Collection`](types.mdx#collection)
...
• **Options** *extends* [`SortByOptions`](types.mdx#sortbyoptions)
...
[collection.ts:182](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/collection.ts#L182)

***

### stats()

> **stats**\<`Iterable`, `Options`\>(`collection`, `options`): [`Stats`](types.mdx#stats)
...
• **Options** *extends* [`StatsOptions`](types.mdx#statsoptions)
...
[`Stats`](types.mdx#stats)

#### Defined in

[collection.ts:67](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/collection.ts#L67)
