---
title: Accessibility
description: Functions for handling color accessibility.
---
...
[accessibility.ts:30](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/accessibility.ts#L30)

***

### deficiency()

> **deficiency**\<`Color`, `Options`\>(`color`, `options`?): [`ColorToken`](types.mdx#colortoken)
...
• **Options** *extends* [`DeficiencyOptions`](types.mdx#deficiencyoptions)
...
[accessibility.ts:140](https://github.com/prjctimg/huetiful/blob/d07000fddff896b916bf99e717462d82d74f1005/lib/accessibility.ts#L140)
