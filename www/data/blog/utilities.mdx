...
date: 2024-07-14
lastmod: 2024-07-14
summary: Functions for general purpose set/get snd conversion operations on color tokens.
canonicalUrl: https://huetiful-js.com/api/utilities
---


[huetiful-js](modules.mdx) / utilities
...
utilities/index.js:81

***

### complimentary()

> **complimentary**(`baseColor`, `obj`): `string` | `number` | `boolean` | `object` | `number`\[] | \[`string`, `number`, `number`, `number`, `number?`] | `Blob` | `ArrayBuffer` | \{`color`: [`ColorToken`](accessibility.mdx#colortoken);`factor`: `number`; }
...
`string` | `number` | `boolean` | `object` | `number`\[] | \[`string`, `number`, `number`, `number`, `number?`] | `Blob` | `ArrayBuffer` | \{`color`: [`ColorToken`](accessibility.mdx#colortoken);`factor`: `number`; }
