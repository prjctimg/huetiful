...
date: 2024-07-14
lastmod: 2024-07-14
summary: Wrapper functions for creating "read-manipulate-output " chains (via method chaining) for a more concise syntax.
canonicalUrl: https://huetiful-js.com/api/wrappers
---


[huetiful-js](modules.mdx) / wrappers
...
> **filterBy**(`options`): [`ColorArray`](wrappers.mdx#colorarray)
...
• **against**: [`ColorToken`](accessibility.mdx#colortoken)
...
> **sortBy**(`options`): [`ColorArray`](wrappers.mdx#colorarray)
...
• **options**: [`SortByOptions`](collection.mdx#sortbyoptions)
...
• **options**: [`StatsOptions`](collection.mdx#statsoptions)
