      ...
      window.$docsify = {
        ...
        nameLink: "https://huetiful-js.com", nativeEmoji: true,
        notFoundPage: '/assets/pages/_404.md', topMargin: 50,
        progress: {
          position: "top",
        ...
        pagination: {
          previousText: 'Back to', nextText: 'Up next',
          crossChapter: true,
          ...
          float: 'right',
          fontsize: '0.9em',
          color: 'rgb(90,90,90)', isExpexted: true
        }, accordify: {
