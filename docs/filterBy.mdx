...
▸ **filterByContrast**(`colors`, `against`, `startContrast?`, `endContrast?`): `Color`[]

#### Parameters

| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `colors` | `Color`[] | `undefined` | The array of colors to filter. |
| `against` | `Color` | `undefined` | - |
...
▸ **filterByDistance**(`colors`, `against`, `startDistance?`, `endDistance?`, `mode?`, `weights?`): `Color`[]
...
| `mode?` | `ColorSpaces` | `undefined` | The color space to calculate the distance in . |
...
▸ **filterByHue**(`colors`, `startHue?`, `endHue?`): `Color`[]
...
▸ **filterByLightness**(`colors`, `startLightness?`, `endLightness?`): `Color`[]
...
▸ **filterByLuminance**(`colors`, `startLuminance?`, `endLuminance?`): `Color`[]
...
▸ **filterBySaturation**(`colors`, `startSaturation?`, `endSaturation?`): `Color`[]
...
▸ **filterByTemp**(`colors`, `startTemp?`, `endTemp?`): `Color`[]
