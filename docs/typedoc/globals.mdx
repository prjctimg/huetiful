...
> **new ColorArray**(`colors`): [`ColorArray`](globals.mdx#colorarray)
...
[`ColorArray`](globals.mdx#colorarray)
...
> **discover**(`options`): [`ColorArray`](globals.mdx#colorarray)
...
> **filterBy**(`options`): [`ColorArray`](globals.mdx#colorarray)
...
> **interpolator**(`options`): [`ColorArray`](globals.mdx#colorarray)
...
> **nearest**(`against`, `num`): [`ColorArray`](globals.mdx#colorarray)

Returns the nearest color(s) in the bound collection against

###### Parameters

• **against**: [`ColorToken`](globals.mdx#colortoken)
...
> **sortBy**(`options`): [`ColorArray`](globals.mdx#colorarray)
...
• **options**: [`SortByOptions`](globals.mdx#sortbyoptions)
...
• **options**: [`StatsOptions`](globals.mdx#statsoptions)
...
• **color**: [`ColorToken`](globals.mdx#colortoken)
...
• **shade**: [`TailwindColorFamilies`](globals.mdx#tailwindcolorfamilies) \| `"all"` = `"all"`

The hue family to return.

• **value**: [`ScaleValues`](globals.mdx#scalevalues) = `undefined`
...
• **baseColor**: [`ColorToken`](globals.mdx#colortoken)
...
• **a**: [`ColorToken`](globals.mdx#colortoken)

First color to query.

• **b**: [`ColorToken`](globals.mdx#colortoken)
...
> **deficiency**(`color`, `options`): [`ColorToken`](globals.mdx#colortoken)
...
• **options**: [`DeficiencyOptions`](globals.mdx#deficiencyoptions) = `...`

#### Returns

[`ColorToken`](globals.mdx#colortoken)
...
• **scheme**: [`DivergingScheme`](globals.mdx#divergingscheme)
...
> **earthtone**(`baseColor`, `options`): [`ColorToken`](globals.mdx#colortoken) \| [`ColorToken`](globals.mdx#colortoken)[]
...
[`ColorToken`](globals.mdx#colortoken) \| [`ColorToken`](globals.mdx#colortoken)[]
...
> **interpolator**(`baseColors`, `options`): [`ColorToken`](globals.mdx#colortoken)[]
...
utilities/index.js:252

***

### luminance()

> **luminance**(`color`, `amount`?): [`ColorToken`](globals.mdx#colortoken)
...
utilities/index.js:534

***

### mc()

> **mc**(`modeChannel`): (`color`, `value`?) => [`ColorToken`](globals.mdx#colortoken)
...
utilities/index.js:672

***

### pair()

> **pair**(`baseColor`, `options`): [`ColorToken`](globals.mdx#colortoken) \| [`ColorToken`](globals.mdx#colortoken)[]
...
> **pastel**(`baseColor`, `options`): [`ColorToken`](globals.mdx#colortoken)
...
• **options**: [`TokenOptions`](globals.mdx#tokenoptions) = `undefined`
...
• **scheme**: [`QualitativeScheme`](globals.mdx#qualitativescheme)
...
• **baseColor**: [`ColorToken`](globals.mdx#colortoken) = `"cyan"`
...
> **sequential**(`scheme`): `Collection` \| [`ColorToken`](globals.mdx#colortoken)

A wrapper function for ColorBrewer's map of sequential color schemes.

#### Parameters

• **scheme**: [`SequentialScheme`](globals.mdx#sequentialscheme)

The name of the scheme.

#### Returns

`Collection` \| [`ColorToken`](globals.mdx#colortoken)
...
• **options**: [`SortByOptions`](globals.mdx#sortbyoptions) = `undefined`
...
• **options**: [`StatsOptions`](globals.mdx#statsoptions) = `undefined`
...
utilities/index.js:641

***

### token()

> **token**(`color`, `options`): [`ColorToken`](globals.mdx#colortoken)
...
utilities/index.js:296

## Type Aliases

### AdaptivePaletteOptions

> **AdaptivePaletteOptions**: \{`backgroundColor`: \{`dark`: [`ColorToken`](globals.mdx#colortoken);`light`: [`ColorToken`](globals.mdx#colortoken); \};`colorBlind`: `boolean`; \}

#### Type declaration

##### backgroundColor?

> `optional` **backgroundColor**: \{`dark`: [`ColorToken`](globals.mdx#colortoken);`light`: [`ColorToken`](globals.mdx#colortoken); \}

##### backgroundColor.dark?

> `optional` **dark**: [`ColorToken`](globals.mdx#colortoken)

##### backgroundColor.light?

> `optional` **light**: [`ColorToken`](globals.mdx#colortoken)
...
> **DeficiencyOptions**: \{`kind`: [`DeficiencyType`](globals.mdx#deficiencytype);`severity`: `number`;`token`: [`TokenOptions`](globals.mdx#tokenoptions); \}
...
> `optional` **kind**: [`DeficiencyType`](globals.mdx#deficiencytype)
...
> `optional` **token**: [`TokenOptions`](globals.mdx#tokenoptions)
...
> **DistributionOptions**: `Pick`\<`InterpolatorOptions`, `"hueFixup"`\> & \{`colorspace`: [`Colorspaces`](globals.mdx#colorspaces);`excludeAchromatic`: `boolean`;`excludeSelf`: `boolean`;`extremum`: `"min"` \| `"max"` \| `"mean"`;`token`: [`TokenOptions`](globals.mdx#tokenoptions); \}
...
> `optional` **colorspace**: [`Colorspaces`](globals.mdx#colorspaces)
...
> **SortByOptions**: \{`against`: [`ColorToken`](globals.mdx#colortoken);`colorspace`: [`Colorspaces`](globals.mdx#colorspaces);`factor`: [`Factor`](globals.mdx#factor);`order`: `"asc"` \| `"desc"`;`relative`: `boolean`; \}
...
> `optional` **against**: [`ColorToken`](globals.mdx#colortoken)
...
> `optional` **factor**: [`Factor`](globals.mdx#factor)
...
> **StatsOptions**: \{`against`: [`ColorToken`](globals.mdx#colortoken);`colorspace`: [`Colorspaces`](globals.mdx#colorspaces);`factor`: [`Factor`](globals.mdx#factor) \| [`Factor`](globals.mdx#factor)[];`relative`: `boolean`; \}
...
> `optional` **factor**: [`Factor`](globals.mdx#factor) \| [`Factor`](globals.mdx#factor)[]
...
> **TokenOptions**: \{`kind`: `"num"` \| `"arr"` \| `"obj"` \| `"str"` \| `"temp"`;`normalizeRgb`: `boolean`;`numType`: `"expo"` \| `"hex"` \| `"oct"` \| `"bin"`;`omitAlpha`: `boolean`;`omitMode`: `boolean`;`srcMode`: [`Colorspaces`](globals.mdx#colorspaces);`targetMode`: [`Colorspaces`](globals.mdx#colorspaces); \}
...
> `optional` **srcMode**: [`Colorspaces`](globals.mdx#colorspaces)
...
> `optional` **targetMode**: [`Colorspaces`](globals.mdx#colorspaces)
