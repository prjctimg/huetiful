...
| :------ | :------ | :------ |
| `color` | `Color` | The color to query its temperature value |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `color` | `Color` | The color to convert to its numerical equivalent. |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `color` | `Color` | The color to convert to hexadecimal. Works on color objects and CSS named colors. |
