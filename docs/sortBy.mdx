...
▸ **sortByContrast**(`colors`, `against`, `order`): `Color`[]

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `colors` | `Color`[] | The array of colors to sort |
| `against` | `Color` | - |
...
▸ **sortByDistance**(`colors`, `against`, `order?`, `mode?`, `weights?`): `Color`[]
...
| :------ | :------ | :------ |
| `colors` | `Color`[] | The array of colors to sort. |
| `against` | `Color` | The color to compare the distance with. All the distances are calculated between this color and the ones in the colors array. |
| `order?` | ``"asc"`` \| ``"desc"`` | The expected order of arrangement. Either 'asc' or 'desc'. Default is ascending ('asc') |
| `mode?` | `ColorSpaces` | The color space to calculate the distance in . |
...
▸ **sortByLightness**(`colors`, `order`): `Color`[]
...
▸ **sortByLuminance**(`colors`, `order`): `Color`[]
...
▸ **sortBySaturation**(`colors`, `order`): `Color`[]
