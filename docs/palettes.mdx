...
▸ **base**(`scheme`): (`color`: `Color`, `hex`: `boolean`, `easingFunc`: (`t`: `number`) => `number`) => `Color`[]
...
▸ **discoverPalettes**(`colors`, `scheme`): `object` \| `Color`[]

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `colors` | `Color`[] | The array of colors to create palettes from. Preferably use 5 or more colors for better results. |
...
▸ **earthtone**(`color`, `earthtone?`, `iterations?`, `options?`): `Color`[]

#### Parameters

| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `color` | `Color` | `undefined` | The color to interpolate an earth tone with. |
| `earthtone?` | `Earthtones` | `undefined` | The earthtone to interpolate with. |
...
▸ **getComplimentaryHue**(`color`, `colorObj?`): `Color` \| \{ `color`: `Color` ; `hue`: `string`  }

#### Parameters

| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `color` | `Color` | `undefined` | The color to retrieve its complimentary hue. |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `color` | `Color` | The color to query its shade or hue family. |
...
▸ **hueShift**(`color`, `hex?`, `options?`): `Color`[]

#### Parameters

| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `color` | `Color` | `undefined` | The color to use as the base of the hueshift. Colors are internally converted to LCH. |
...
▸ **pairedScheme**(`color`, `options`): `Color`[]

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `color` | `Color` | The color to return a paired color scheme from. |
...
▸ **pastel**(`color`, `hex?`): `Color`

#### Parameters

| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `color` | `Color` | `undefined` | The color to return a pastel variant of. |
