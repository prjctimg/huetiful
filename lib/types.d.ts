/**
 * (c) 2025 Dean Tarisai
 * Type definitions for huetiful-js. 
 * All types used throghout  other modules lead here
 * for easier reference similar to a manpage.
 *
 */
 ...
 */
export type PairedSchemeOptions =
  InterpolatorOptions & {
    /**
 ...
 */
export type DistributionOptions = Pick<
  InterpolatorOptions,
  "hueFixup"
> & {
  /**
